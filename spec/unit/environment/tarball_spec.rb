...
describe R10K::Environment::Tarball do
  ...
  let(:sha256digest) { '36afcfc2378b8235902d6e647fce7479da6898354d620388646c595a1155ed67' }
  let(:base_params) { { source: tgz_path, version: sha256digest, modules: { } } }
  ...
  describe "storing attributes" do
    ...
    it "can return the environment version" do
      expect(subject.tarball.sha256digest).to eq sha256digest
    end
  end
end
